...
from adminsortable2.admin import SortableTabularInline, SortableAdminBase, SortableAdminBase, SortableAdminBase
...
class ProductAdmin(SortableAdminBase, admin.ModelAdmin):
    ...
    # slug is auto-generated and drives live URLs -- never let Kevin edit it
    ...
    @admin.action(description="Mark selected products as In Stock (qty 1)")
